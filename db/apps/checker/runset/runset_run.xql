...
let $runset := request:get-parameter('runset', '')
let $format := request:get-parameter('format','report')
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    for $step-id at $pos in $steps
        ...
        <div>
            ...
            {
                let $result := run:run($group, $step-id, $cmd-path, $cmd-file, $uri, $ct-home-web, $ct-home-db, $ct-home-data, $debug)
                return 
