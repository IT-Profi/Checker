    ...
    <body>
        <xf:model id="ConfigModel" schema="{$ct-home-web}/base/checker.xsd">
           ...
           <xf:bind ref="instance('message')/master/rest/url" 
            ...
            <xf:submission id="load-current-soap" method="post" instance="step" replace="text" targetref="/cs:step/cs:checkset/cs:current/cs:document/cs:data" mediatype="text/xml" encoding="utf-8"
