...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <subtitle>Are you sure you want to delete the fileset '{$fileset}'?</subtitle>
        <br/>
        <br/>
        <a class="warn" href="delete_response.html">Yes - Delete this fileset</a>
        <br/><br/>
        <br/>
        <a  class="warn" href="../../step/overview.html">No - Go back to step overview</a>
    </body>
</html>