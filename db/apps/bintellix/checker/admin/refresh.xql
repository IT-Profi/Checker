...
{    
    ...
    (
        ...
        sm:chmod(xs:anyURI(concat($ct-home-db,'/fileset/fileset_run.xql')), "rwsr-xr-x"),
    ...
    (
        sm:chmod(xs:anyURI(concat($ct-home-db,'/admin/config_edit.xql')), "rwxr-xr-x"),
        sm:chmod(xs:anyURI(concat($ct-home-db,'/admin/config_edit_response.xql')), "rwxr-xr-x"),
        sm:chmod(xs:anyURI(concat($ct-home-db,'/admin/validate.xql')), "rwxr-xr-x")
    )
}
