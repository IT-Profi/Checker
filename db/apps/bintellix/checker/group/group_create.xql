...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:xf="http://www.w3.org/2002/xforms" xmlns:ev="http://www.w3.org/2001/xml-events" xmlns:ct="http://compare.bintellix.de">
    <head>
        <xf:model schema="{$ct-home-web}/base/checker.xsd">
            ...
            <xf:submission id="save" method="get" action="create_response.html" replace="all" instance="request">
            ...
            <xf:bind nodeset="instance('request')/step_new" type="cs:LimitedParameterIdentifierType" required="false()"/>
        </xf:model>
    </head>
    <body>
        <xf:group appearance="full">
            <xf:label>Create new Group</xf:label>
            <xf:input ref="group_new" incremental="true">
                <xf:label>Group name: </xf:label>
                <xf:hint>New_Step_Name</xf:hint>
        ...
        <xf:group>
            <xf:submit submission="save">
                <xf:label>Create group</xf:label>
            </xf:submit>
        </xf:group>
    </body>
</html>